...
export default function Organization() {
  ...
  const Column = ({ label, status, color }: { label: string; status: Status; color: string }) => {
    ...
    return (
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-4 min-h-[400px]">
        ...
        <div className="grid gap-2">
          {columnTasks.map(task => (
            <div key={task.id} className="bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg p-3">
  ...
  return (
    <section className="grid gap-6">
      <div>
        <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50">Organization</h2>
        <p className="text-sm text-zinc-500 mt-1">Manage your tasks with a simple Kanban board</p>
      </div>

      <form onSubmit={addTask} className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 grid gap-4">
      ...
      <div className="grid lg:grid-cols-3 gap-4">
        <Column label="To Do" status="todo" color="text-zinc-700 dark:text-zinc-300" />
